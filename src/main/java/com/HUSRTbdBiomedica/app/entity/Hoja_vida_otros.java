...
public class Hoja_vida_otros implements Serializable{
	...
	@Column(name="riesgona_otros")
	private boolean Riesgona_otros;
	...
	public boolean isRiesgona_otros() {
		return Riesgona_otros;
	}


	public void setRiesgona_otros(boolean riesgona_otros) {
		Riesgona_otros = riesgona_otros;
	}
